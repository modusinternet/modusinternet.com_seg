...
if(!isset( $json['error'])) {
	...
	// Email text
	$mail_message = "This email message was sent by someone using the Investing Opportunities - Contact Us Form on <a href=\"" . $_SERVER["HTTP_REFERER"] . "\">" . $_SERVER["HTTP_REFERER"] . "</a>.<br /><br />IP Address: " . $_SERVER["REMOTE_ADDR"] . "<br />";
...
<div style='color: gray; font-size: .8em;'>
    ...
    // Sending email
    mail( $CFG["EMAIL_FROM"], "Email from " . $CFG["DOMAIN"] . ", Investing Opportunities - Contact Us Form", $mail_message, $mail_headers, "-f" . $CFG["EMAIL_BOUNCES_RETURNED_TO"] );
